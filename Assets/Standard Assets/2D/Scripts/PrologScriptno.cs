...
public class PrologScriptno : MonoBehaviour {
	//public AudioClip typingsound;
	public GameObject asd;
	public string txtname;//로드할 대본 이름,일단은 1오브젝트= 1대본이라 생각하고, 인스펙터에서 직접 지정한다.
	...
	void Start () {
		...
		if(GameObject.Find ("data").GetComponent<Data> ().item303==0){
			txtname="person";
		}
